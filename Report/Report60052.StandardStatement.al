report 60052 "Standard Statement1"
{
    RDLCLayout = './Report/StandardStatement1.rdlc';
    WordLayout = './Report/StandardStatement1.docx';
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            begin
                                ...
                                If SalesInvoiceHeader.Get("Document No.") then
                                    Description := SalesInvoiceHeader."Sell-to Customer No." + ' ' + SalesInvoiceHeader."Sell-to Customer Name";
                            end;
