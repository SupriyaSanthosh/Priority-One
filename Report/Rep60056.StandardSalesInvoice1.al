report 60056 "Standard Sales Invoice1"
{
    RDLCLayout = './Report/StandardSalesInvoice1.rdl';
    WordLayout = './Report/StandardSalesInvoice1.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(AmountSubjectToSalesTaxLbl; 'AmountSubjectToSalesTaxLbl')
            {

            }
            column(WorkDescription_Header; Header.GetWorkDescription)
            {
            }
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(JobWorkDescription; "Work Description")
                {
                }
                column(JobWorkDescriptionLbl; JobWorkDescriptionLbl)
                {
                }
    ...
    var
        ...
        JobNo: Code[20];
        JobTaskNo: Code[20];
        JobWorkDescription: Text[500];
        Currency: Code[20];
        JobWorkDescriptionLbl: Label 'Work Description';
