page 60055 "Standing Invoice"
{
    Caption = 'Standing Invoice';
    PageType = Document;
        ...
        area(content)
        {
            group(General)
            {
                ...
                field(SalesPersonName; SalesPerson.Name)
                {
                    ...
                    ToolTip = 'Specifies the name of SalesPerson.';
                }
                ...
                field("Last Date Invoiced"; rec."Last Date Invoiced")
                {
                    ToolTip = 'Specifies the DateTime when last invoice created';
                    ApplicationArea = All;
                }
            ...
            part(JobPlanningLines1; "Job Planning Lines1")
            {
                ApplicationArea = Jobs;
    ...
    begin
        ...
        Rec.CalcFields("Salesperson Code");
